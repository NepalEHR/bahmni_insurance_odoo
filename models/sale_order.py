...
#             record = super(sale_order, self).action_invoice_create(grouped, final)
                ...
                if group_key not in invoices:
                    ...
                    for inv_data in invoice_data:
                        ...
                        if line.qty_to_invoice > 0:
                            self.line_invoice_addition(line, invoice,final)
                    ...
                    if line.qty_to_invoice > 0:
                        self.line_invoice_addition(line, invoices[group_key],final)
                    elif line.qty_to_invoice < 0 and final:
                        self.line_invoice_addition(line, invoices[group_key],final)
    ...
    def line_invoice_addition(self, line, invoice,final):
        if line.qty_to_invoice > 0:
